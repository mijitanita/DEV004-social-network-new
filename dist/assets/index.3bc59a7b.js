...
const wall = () => {
  ...
  imgUser.src = imgUserImg;
  imgUser.alt = "imgUser";
  logo2.src = logoregImg;
  logo2.alt = "Logo";
  fondo.src = fondoImg;
  fondo.alt = "Fondo";
